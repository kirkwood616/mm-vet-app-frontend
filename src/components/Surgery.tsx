    ...
    <div className="Surgery">
      ...
      <div className="Surgery paragraph">
        <p>
          ...
          orthopedic surgical procedures. Some of the common procedures include:
          spays and neuters, growth removals, and foreign body removal.
          Orthopedic procedures commonly performed include: fracture repair with
          plates, pins, or external fixators, cruciate ligament repair, luxating
          patellas, and FHO surgeries for hip dysplasia.
        </p>
        <br />
        <p>
          Surgery is often the most effective way to treat many serious injuries
          and disorders, and Fowlerville Veterinary Clinic is proud to offer
        ...
        <p>
          If you are considering veterinary surgery for your pet, please contact
          us at (555)555-5555 to schedule a consultation with your M&M
