            ...
            <div className="cards-shadow">
              <div className="cards-header card-image">
                ...
                <div className="cards-body">
                  <h1>Microchipping</h1>
                  <p>
                    Microchip identification is the most reliable way to reunite
            ...
            <div className="cards-shadow">
              <div className="cards-header card-image">
                ...
                <div className="cards-body">
                  <h1>Grooming</h1>
                  <p>
                    We offer the finest in all breed grooming services for your
                    pet. Our groomers are experienced, kind, and hard-working!
                    Let us pamper your pet and make them look their best.
                  </p>
                </div>
                <div className="cards-footer">
