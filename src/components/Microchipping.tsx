    ...
    <div className="Microchipping">
      ...
      <div className="Microchipping paragraph">
        ...
        <p>
          ...
          dogs, and other animals to their homes every day. Pet ID chips are the
          most reliable way to reunite pets with their owners and provide peace
          of mind.
        </p>
        <br />
        ...
        <p>
          ...
          they stay indoors, but in our experience, these are the most likely to
          become lost when they accidentally get outside. As separation from
          your cat or dog can happen all too easily, permanent identification by
          microchipping is critical. Every pet should have microchip
          identification as the procedure can be done at any age.
        </p>
        <br />
        ...
        <p>
          ...
          whole life of the pet. Your information has to be registered with your
          bar code number so that you can be contacted if your pet ever becomes
          lost.
        </p>
        <p>
          ...
          reader that is simply waved over the skin. Once a microchip is found,
          a special hotline is called, and the lost pet is reported. The pet
          owner is then called immediately and given the contact information
          about where to pick up their pet.
        </p>
        <br />
        <p>
